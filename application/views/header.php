  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar bg-gray-dark col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center bg-gray-dark">
          <a class="navbar-brand brand-logo text-white font-bold" href="<?php echo base_url() ?>"><b></b></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>Home/add_client">Add User</a></li>
                       <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>Home/view_clients">User Management</a></li>
