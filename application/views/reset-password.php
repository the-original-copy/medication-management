...
<head>
	...
	<title>MediApp||Forgot Password Page</title>
...
<label style="color:#000">Registered Email address</label>								
<?php echo form_input(['name'=>'email','id'=>'email','class'=>'form-control','placeholder'=>'Email address','value'=>set_value('fromdate')]);?>
<?php echo form_error('email','<div style="color:red">','<div>')?>
							</div>
							
							<div class="form-group">
<label style="color:#000">Registered Mobile number</label>

					<?php echo form_input(['name'=>'MobileNumber','id'=>'MobileNumber','class'=>'form-control','placeholder'=>'Mobile number','value'=>set_value('fromdate')]);?>
...
<?php echo form_password(['name'=>'newpassword','id'=>'newpassword','class'=>'form-control','placeholder'=>'New Password','value'=>set_value('newpassword')]);?>	
